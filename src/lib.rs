...
#[derive(Debug)]
pub struct SensorEmberProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SensorEmberProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SensorEmber processing");
    
    let mut processor = SensorEmberProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SensorEmberProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SensorEmberProcessor::new(false);
